...
SELECT
s.id, s.name, s.quality1, s.quality2
FROM students s
WHERE (quality1 = 'hufflepuff' OR  quality2 = 'hufflepuff') --hufflepuff
OR
(quality1 = 'evil' AND quality2 = 'cunning') --slythering
OR
(quality1 = 'brave' AND NOT quality2 = 'evil') --gryffindor
OR
(quality1= 'studious' OR quality2 = 'intelligent' OR quality2 = 'studious') -- ravenclaw
ORDER BY s.id ASC;
